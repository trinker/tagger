...
[![Build Status](https://travis-ci.org/trinker/tagger.svg?branch=master)](https://travis-ci.org/trinker/tagger)
[![Coverage Status](https://coveralls.io/repos/trinker/tagger/badge.svg?branch=master)](https://coveralls.io/r/trinker/tagger?branch=master)

`r verbadge`

**tagger** wraps the **NLP** and **openNLP** packages for easier part of speech tagging.
